...
export default class App extends React.Component {
  ...
  calculate() {
    this.afterInflation = this.calculateInflationImpact(
      this.state.amount,
    ...
    this.atRiskFreeAfterInflation = this.calculateInflationImpact(
      this.atRiskFree,
      this.state.inflationRate / 100,
      this.state.timeInYears,
    );
    this.difference = this.atRiskFreeAfterInflation - this.afterInflation;

    this.setState({
      afterInflation: this.afterInflation,
      atRiskFree: this.atRiskFree,
      atRiskFreeAfterInflation: this.atRiskFreeAfterInflation,
